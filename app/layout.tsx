...
export const metadata: Metadata = {
  title: "TickitIQ",
  description: "A real-time event ticketing platform built with Next.js, Convex, Clerk, and Stripe. Features smart queuing, secure payments, and live ticket updates.",
  icons: {
    icon: "/convex.svg",
  },
};
